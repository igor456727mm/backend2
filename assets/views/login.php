    ...
    <div class="row" style="margin-top: 100px;">
        ...
        <fieldset>
            <div style="text-align: center; font-size: 20px; margin-top: 0px;">
                <? echo $localizator->__('SIGN IN'); ?> </div>
            <span><? echo $localizator->__('USERNAME'); ?></span><br/>
        ...
        <div class="row">
                <div class="col-md-12" style="text-align:center;">
                    <button submitform='true' type="submit" id='submit' class="btn btn-success" style="width: auto;"><? echo $localizator->__('Sign in'); ?></button>
                </div>
